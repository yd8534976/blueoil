    ...
    def base(self, images, is_training):
        ...
        def connect_block(lateral, up, name="connect_block"):
            with tf.variable_scope(name_or_scope=name):
                ...
                out = darknet_block("block", out, filters=64, kernel_size=3)
            return out
        ...
        x = connect_block(lateral=c4,
                          up=x,
                          name="connect_block1")
        x = connect_block(lateral=c3,
                          up=x,
                          name="connect_block2")

        x = darknet_block("block_12", x, filters=64, kernel_size=3)
