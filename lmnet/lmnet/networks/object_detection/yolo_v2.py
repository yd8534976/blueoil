...
class YoloV2(BaseNetwork):
    ...
    def __init__(
        ...
        assert self.image_size[0] % self.cell_size == 0
        assert self.image_size[1] % self.cell_size == 0
        ...
        if self.is_dynamic_image_size:
            ...
            image_size0 = self.image_size[0] / self.cell_size
            image_size1 = self.image_size[1] / self.cell_size
            self.num_cell = tf.tuple([tf.cast(image_size0, tf.int32), tf.cast(image_size1, tf.int32)])
        else:
            self.num_cell = self.image_size[0] // self.cell_size, self.image_size[1] // self.cell_size
