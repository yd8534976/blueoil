...
from lmnet.networks.object_detection.denseface import LMFYoloQuantize
...
NETWORK.LEARNING_RATE_KWARGS = {
        "values": [5e-4, 2e-3, 5e-4, 5e-5, 5e-5],
        "boundaries": [1000, step_per_epoch * 10, step_per_epoch * 30, step_per_epoch * 50],
}
